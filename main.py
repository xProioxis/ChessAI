        ...
        if checkmate("b", square_list):
            ...
            if square_active[0]: # if a square is currently being clicked
                if square_active[1].piece is not None:
                    # main movement logic
                    pieces_paths = list(get_path(square_active[1], square_list))
                    deleted_moves = 0
                    for square in pieces_paths: # will return the possible spaces a piece can move
                        castled = False
                    ...
                    if deleted_moves == len(pieces_paths):
                        square_active = False, None
